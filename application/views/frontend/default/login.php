...
<section class="category-course-list-area">
    <div class="container">
      ...
      <div class="row mb-5 mt-3">
        <div class="col-md-12 text-left" style="color:#F58634;">
        ...
        <div class="col-lg-6 d-none d-lg-block text-center">
            ...
            <img class="mt-4" width="100%" height="500vh" style="margin-top:-100px;" src="<?php echo base_url('uploads/system/auth-banner.jpg'); ?>">
          </div>
      </div>
    </div>
</section>